...
var Itau = (function() {
	...
	Itau.prototype.geraCodigoDeBarrasPara = function(boleto) {
		...
		// var digito2 = GeradorDeDigitoPadrao.mod11(campoLivre.substring(11, 20) + campoLivre.substring(0, 11));
		// antes era utilizado o digito2 como parametro para o insert abaixo foi mudado para beneficiario._digitoNossoNumero
		campoLivre = insert(campoLivre, 11, beneficiario._digitoNossoNumero);
